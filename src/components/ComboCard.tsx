...
export default function ComboCard({ name, description, price, image_url }: ComboCardProps) {
  ...
  return (
    <article className="bg-white rounded-xl shadow-md overflow-hidden border-2 border-[var(--primary)]/20 flex flex-col hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 max-w-full">
